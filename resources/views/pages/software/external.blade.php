                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-3 text-slate-500 dark:text-slate-400">
                                <form method="POST" action="{{ route('software.external.copy', $soft->id) }}">
                                    @csrf
                                    <button title="Copy" class="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-slate-200 bg-white hover:bg-slate-50 dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10 text-green-500 dark:text-green-400">
                                ...
                                <form method="POST" action="{{ route('software.external.destroy', $soft->id) }}">
                                    @csrf
                                    <button title="Copy" class="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-slate-200 bg-white hover:bg-slate-50 dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10 text-red-500 dark:orange-red-400">
