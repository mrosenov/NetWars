                ...
                <div class="mx-auto max-w-xl rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#070A0F]/60">
                    ...
                    <form method="POST" action="{{ route('internet.login', ['ip' => $ip]) }}" class="px-6 py-6 space-y-4">
                        ...
                        <div class="flex items-center rounded-xl bg-slate-100 px-3 py-2 focus-within:ring-2 focus-within:ring-cyan-500/40 dark:bg-white/5 dark:focus-within:ring-cyan-400/40">
                            ...
                            <input name="username" value="{{ old('username') }}" placeholder="Username" class="w-full bg-transparent border-0 p-0 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-0 dark:text-slate-100 dark:placeholder:text-slate-500" />
                        </div>
                        ...
                        <div class="flex items-center rounded-xl bg-slate-100 px-3 py-2 focus-within:ring-2 focus-within:ring-cyan-500/40 dark:bg-white/5 dark:focus-within:ring-cyan-400/40">
                            ...
                            <input name="password" type="password" placeholder="Password" class="w-full bg-transparent border-0 p-0 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-0 dark:text-slate-100 dark:placeholder:text-slate-500" />
                        </div>
