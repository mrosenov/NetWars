        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between p-4">
            ...
            <div class="flex w-full items-center gap-3">
                ...
                <div class="flex-1 flex items-center gap-2 rounded-xl bg-slate-100 px-3 py-2 focus-within:ring-2 focus-within:ring-cyan-500/40 dark:bg-white/5 dark:focus-within:ring-cyan-400/40">
                    ...
                    <input type="text" name="ip" placeholder="1.2.3.4" value="{{ request('ip') }}"
            ...
            <div class="flex items-center gap-2 sm:pl-3">
                {{-- Home --}}
                <a href="{{ route('internet.index') }}" class="inline-flex h-9 w-9 items-center justify-center rounded-xl
                    border border-slate-200 bg-white shadow-sm
                    text-slate-600 hover:-translate-y-0.5 hover:scale-[1.02] active:scale-95 hover:shadow-md hover:text-cyan-600
                    transition dark:border-white/10 dark:bg-white/5 dark:text-slate-300 dark:hover:text-cyan-400"
                >
