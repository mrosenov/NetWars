<aside class="lg:sticky lg:top-20 h-fit">
    <div class="rounded-2xl border border-slate-200 bg-white/80 shadow-sm backdrop-blur dark:border-white/10 dark:bg-white/5 dark:shadow-glow">
        ...
        <nav class="p-2">
            ...
            <a class="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm transition hover:bg-slate-100 dark:hover:bg-white/5 {{ request()->routeIs('dashboard')  ? 'bg-slate-100 dark:bg-white/5' : '' }}" href="{{route('dashboard')}}">
            ...
            <a class="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm transition hover:bg-slate-100 dark:hover:bg-white/5 {{ request()->routeIs('tasks.index') || request()->routeIs('tasks.*')  ? 'bg-slate-100 dark:bg-white/5' : '' }}" href="{{ route('tasks.index') }}">
                  <span class="grid h-8 w-8 place-items-center rounded-xl border border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-white/5">
            ...
            <a class="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm transition hover:bg-slate-100 dark:hover:bg-white/5 {{ request()->routeIs('software.index') || request()->routeIs('software.*')  ? 'bg-slate-100 dark:bg-white/5' : '' }}" href="{{ route('software.index') }}">
                  <span class="grid h-8 w-8 place-items-center rounded-xl border border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-white/5">
            ...
            <a class="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm transition hover:bg-slate-100 dark:hover:bg-white/5 {{ request()->routeIs('internet.*') || request()->routeIs('target.*')  ? 'bg-slate-100 dark:bg-white/5' : '' }}" href="{{ route('internet.index') }}">
                  <span class="grid h-8 w-8 place-items-center rounded-xl border border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-white/5">
            ...
            <a class="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm transition hover:bg-slate-100 dark:hover:bg-white/5 {{ request()->routeIs('user.logs') ? 'bg-slate-100 dark:bg-white/5' : '' }}" href="{{ route('user.logs') }}">
                  <span class="grid h-8 w-8 place-items-center rounded-xl border border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-white/5">
            ...
            <a class="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm transition hover:bg-slate-100 dark:hover:bg-white/5 {{ request()->routeIs('user.hardware') || request()->routeIs('user.hardware.*')  ? 'bg-slate-100 dark:bg-white/5' : '' }}" href="{{ route('user.hardware') }}">
                  <span class="grid h-8 w-8 place-items-center rounded-xl border border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-white/5">
